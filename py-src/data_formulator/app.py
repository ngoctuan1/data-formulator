...
from data_formulator.agents.agent_recomendation import RecommendAgent
    ...
    example_datasets = [
        {
            ...
            "challenges": [
                {
                    "text": "Create a line chart to show the life expectancy trend of each country over time.",
                    "difficulty": "easy",
                },
                {
                    "text": "Visualize the top 10 countries with highest life expectancy in 2005.",
                    "difficulty": "medium",
                },
                {
                    "text": "Find top 10 countries that have the biggest difference of life expectancy in 1955 and 2005.",
                    "difficulty": "hard",
                },
                {
                    "text": "Rank countries by their average population per decade. Then only show countries with population over 50 million in 2005.",
                    "difficulty": "hard",
                },
            ],
        },
        {
            ...
            "challenges": [
                {
                    "text": "Create a line chart to show the income trend of each state over time.",
                    "difficulty": "easy",
                },
                {
                    "text": "Only show washington and california's percentage of population in each income group each year.",
                    "difficulty": "medium",
                },
                {
                    "text": "Find the top 5 states with highest percentage of high income group in 2016.",
                    "difficulty": "hard",
                },
            ],
        },
        {
            ...
            "challenges": [
                {
                    "text": "Create a scatter plot to show the number of death from each disaster type each year.",
                    "difficulty": "easy",
                },
                {
                    "text": "Filter the data and show the number of death caused by flood or drought each year.",
                    "difficulty": "easy",
                },
                {
                    "text": "Create a heatmap to show the total number of death caused by each disaster type each decade.",
                    "difficulty": "hard",
                },
                {
                    "text": "Exclude 'all natural disasters' from the previous chart.",
                    "difficulty": "medium",
                },
            ],
        },
        {
            ...
            "challenges": [
                {
                    "text": "Create a scatter plot to show the relationship between budget and worldwide gross.",
                    "difficulty": "easy",
                },
                {
                    "text": "Find the top 10 movies with highest profit after 2000 and visualize them in a bar chart.",
                    "difficulty": "easy",
                },
                {
                    "text": "Visualize the median profit ratio of movies in each genre",
                    "difficulty": "medium",
                },
                {
                    "text": "Create a scatter plot to show the relationship between profit and IMDB rating.",
                    "difficulty": "medium",
                },
                {
                    "text": "Turn the above plot into a heatmap by bucketing IMDB rating and profit, color tiles by the number of movies in each bucket.",
                    "difficulty": "hard",
                },
            ],
        },
        {
            ...
            "challenges": [
                {
                    "text": "Create a scatter plot to show the relationship between unemployment rate and year.",
                    "difficulty": "easy",
                },
                {
                    "text": "Create a line chart to show the average unemployment per year for each industry.",
                    "difficulty": "medium",
                },
                {
                    "text": "Find the 5 most stable industries (least change in unemployment rate between 2000 and 2010) and visualize their trend over time using line charts.",
                    "difficulty": "medium",
                },
                {
                    "text": "Create a bar chart to show the unemployment rate change between 2000 and 2010, and highlight the top 5 most stable industries with least change.",
                    "difficulty": "hard",
                },
            ],
        },
    ...
    for dataset in example_datasets:
        ...
        try:
            info_obj = {
                ...
                "snapshot": vega_data(name).to_json(orient="records"),
            }
...
def clean_data_request():
    ...
    if request.is_json:
        ...
        candidates = agent.run(
            ...
            content["raw_data"],
            content["image_cleaning_instruction"],
        )
...
def derive_data():
    ...
    if request.is_json:
        ...
        if mode == "recommendation":
            ...
            results = agent.run(
                input_tables, instruction, [field["name"] for field in new_fields]
            )
        
        ### Get the data summarize and user input ###
        content_desc_data = results[0]['dialog'][-2]['content']
        # Sử dụng re để trích xuất đoạn văn bản giữa các thẻ
        context_to_goal = re.search(r"\[CONTEXT\](.*?)\[GOAL\]", content_desc_data, re.DOTALL)
        goal_to_output = re.search(r"\[GOAL\](.*?)\[OUTPUT\]", content_desc_data, re.DOTALL)

        # Lấy nội dung nếu tìm thấy
        desc_data = context_to_goal.group(1).strip() if context_to_goal else None
        user_input = goal_to_output.group(1).strip() if goal_to_output else None
        ###
        ...
        agent_recommend = RecommendAgent(client=client)
        result_recommend = agent_recommend.run(input_user=user_input, desc_data=desc_data)
        recommend_content = re.findall(r'\d.\s+(.*)\?', result_recommend['content'])
        logger.info(f"Recommends: {recommend_content}")
